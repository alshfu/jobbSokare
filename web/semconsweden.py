...
def semconsweden_actoin(url, id, proffile):
    ...
    driver.find_elements_by_class_name('boolean')[0].send_keys(Keys.SPACE)
    driver.find_elements_by_class_name('boolean')[0].send_keys(Keys.PAGE_DOWN)
    sleep(5)
    driver.find_elements_by_class_name('btn-apply')[1].click()
    sleep(5)
